...
export default function SubjectTemplate({subject, page, content, children}
                                            : {
    subject: string,  // 과목명
        ...
        <div className={styles.wrapper}>
            ...
            <div className={styles.right}>
                <header className={styles.header}>
                    <FontAwesomeIcon icon={faBars} className={styles.nav_icon} onClick={() => setToggleNav(!toggleNav)}/>
